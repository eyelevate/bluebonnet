    ...
    <bootstrap-card class="card-signup" data-background-color="link" use-body="true">
        ...
        <template slot="body">
            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                ...
                <div class="content">
                <!-- Email -->
                    <theme1-input class="form-group-no-border {{ $errors->has('email') ? ' has-danger' : '' }}" 
                        use-icon-pre="true"
                        b-icon-pre="ion-email" 
                    ...
                    <!-- Password -->
                    <theme1-input class="form-group-no-border {{ $errors->has('password') ? ' has-danger' : '' }}" 
                        use-icon-pre="true"
                        b-icon-pre="ion-locked" 
