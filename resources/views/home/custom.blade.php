...
<br />
We know that this process may be unfamiliar to many of our customers and are committed to providing the highest levels of service, consideration and care. 
<br />
...
<br />
  ...
  <section id="section-5">
    <div class="row d-flex justify-content-center">
      <div class="col-6">
                    <hr>
                    <h1 class="text-center">Start the Process</h1>
                    <a href="/contact" class="btn btn-warning btn-block">Contact Us</a>         
      </div>
    </div>
  </section>
...
{{--  
  <section id="section-6">
    <div class="row d-flex justify-content-center">
      ...
      <div class="col-lg-8">
        <hr>
        <h1 class="text-center">“We believe that every love story is unique.”</h1>
        <hr>
      </div>
      <div class="col-12">
