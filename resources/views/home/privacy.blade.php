...
<div class="container">
  ...
  <h1 style="margin-bottom: 25px; text-align: center;">Privacy Policy</h1>
  <p>This privacy policy sets out how Freya's Fine Jewelry uses and protects any information
    that you give us when you use this website. Freya's Fine Jewelry is committed to
    ...
    assured that it will only be used in accordance with this privacy statement. Should we
  ...
  <div class="list-group">
    ...
    <p class="mb-1">
      ...
      <ul>
        ...
        <li>
          demographic information such as preferences, interests, birthdays and anniversaries
        </li>
        <li>
      ...
      <div class="d-flex w-100 justify-content-between">
        <h5 class="mb-1">What We Do With the Information We Gather</h5>
      </div>
      <p class="mb-1">We require this information to understand your needs and provide you with a better service, and in particular for the following reasons:
        <ul>
          <li>
      ...
      <div class="d-flex w-100 justify-content-between">
        <h5 class="mb-1">Links to Other Websites</h5>
      </div>
      <p class="mb-1">
