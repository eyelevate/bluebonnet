...
<div class="container-fluid" style="margin-top:100px;">
	<div class="row-fluid">
		<h1 class="text-center hidden-sm-down">Instant. Magnetic. Enduring. It's Alchemy.</h2>
	...
	<section id="instagram">
		<div class="row">
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<img src="img/themes/theme2/insta1.jpg" class="img-fluid lazy" alt="Responsive image">
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<img src="img/themes/theme2/insta2.jpg" class="img-fluid lazy" alt="Responsive image">
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<img src="img/themes/theme2/insta3.jpg" class="img-fluid lazy" alt="Responsive image">
			</div>
			<div class="col-xs-12 col-sm-6 col-md-4 col-lg-3">
				<img src="img/themes/theme2/insta4.jpg" class="img-fluid lazy" alt="Responsive image">
			</div>
		</div>
